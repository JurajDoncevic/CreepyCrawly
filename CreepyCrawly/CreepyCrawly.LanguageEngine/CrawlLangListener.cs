...
namespace CreepyCrawly.LanguageEngine
{
    public abstract class CrawlLangListener : CrawlLangBaseListener
    {
        ...
        public abstract override void EnterExtract_all_hrefs_command([NotNull] CrawlLangParser.Extract_all_hrefs_commandContext context);
        ...
        public abstract override void EnterForeach_select_command([NotNull] CrawlLangParser.Foreach_select_commandContext context);
        ...
        public abstract override void EnterPartial_extract_text_command([NotNull] CrawlLangParser.Partial_extract_text_commandContext context);
        public abstract override void EnterPartial_extract_title_command([NotNull] CrawlLangParser.Partial_extract_title_commandContext context);
        public abstract override void EnterPartial_extract_image_command([NotNull] CrawlLangParser.Partial_extract_image_commandContext context);
        public abstract override void EnterPartial_extract_script_command([NotNull] CrawlLangParser.Partial_extract_script_commandContext context);
        public abstract override void EnterPartial_extract_href_command([NotNull] CrawlLangParser.Partial_extract_href_commandContext context);
        public abstract override void EnterComposite_extract_command([NotNull] CrawlLangParser.Composite_extract_commandContext context);
        ...
        public abstract override void ExitExtract_all_hrefs_command([NotNull] CrawlLangParser.Extract_all_hrefs_commandContext context);
        ...
        public abstract override void ExitComposite_extract_command([NotNull] CrawlLangParser.Composite_extract_commandContext context);
    }
}
