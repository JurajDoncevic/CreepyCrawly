...
{
    public class ForEachSelectCommand : IComplexCommand
    {
        ...
        public ForEachSelectCommand(List<ICommand> commands, string selector, Func<string, object> executionHead, Func<string, object> executionIterationBegin, Func<object> executionIterationEnd, Func<object> executionTail)
        {
            Name = "FOREACH_SELECT";
            Commands = commands;
            Selector = selector;
