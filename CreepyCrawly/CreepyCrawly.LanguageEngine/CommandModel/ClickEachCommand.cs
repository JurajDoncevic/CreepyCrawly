...
{
    public class ClickEachCommand : IComplexCommand
    {
        ...
        public ClickEachCommand(List<ICommand> commands, string selector, Func<string, object> executionHead, Func<object> executionIterationBegin, Func<object> executionIterationEnd, Func<object> executionTail)
        {
            Name = "CLICK_EACH";
            Commands = commands;
            Selector = selector;
